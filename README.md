# Oi 👋, Eu sou Daniel Lopes

🚀 **Estágio de Engenharia de Software | JavaScript & .NET**  
🇧🇷 Brazil

Estou a procura de estágio de backend e estudante de tecnologia, adquirindo habilidades básicas em desenvolvimento web e sistemas escaláveis.
...
-   🚀 APIs REST com Node.js e Fastify
-   🗄️ PostgreSQL, modelagem e normalização de SQL
-   ⚡ Operações CRUD e noções básicas de desempenho
-   🔐 Noções básicas de autenticação e segurança de APIs
-   🧩 Código limpo e noções básicas de arquitetura de software
-   🤖 Automação e integrações com serviços de terceiros
-   📊 Painéis e projetos de análise de dados
...
> Trata-se de criar soluções que sejam escaláveis, duradouras e que gerem valor real.”_

---

⭐ Se você gosta do meu trabalho, considere marcar um repositório com uma estrela
